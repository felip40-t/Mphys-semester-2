...
# regions = [
#     [(cos_min, cos_min + 0.2), (mass_min, mass_min + 50.0)]
#     for cos_min in [0.0 + 0.2 * i for i in range(5)]
#     for mass_min in [200.0 + 50.0 * j for j in range(16)]
# ]

regions = [
    [(0.9, 0.96), (mass_min, mass_min + 50.0)]
    for mass_min in [300.0 + 50.0 * j for j in range(14)]]
regions += [[(0.2, 0.4), (800.0, 850.0)]]
regions += [[(0.4, 0.6), (950.0, 1000.0)]]
regions += [[(0.8, 1.0), (200.0, 300.0)]]
regions += [[(cos_min, cos_min + 0.1), (270.0, 300.0)]
    for cos_min in [0.0 + 0.2 * i for i in range(5)]]
