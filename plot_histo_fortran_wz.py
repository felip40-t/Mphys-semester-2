...
def plot_combined_histogram(hwU_data, phi_values_e_plus, filepath):
    ...
    # Save the figure
    path = os.path.join(filepath, "phi_hist_comparison_fortran_mu+.png")
    plt.savefig(path)
...
wz_process = {
    ...
    "particles": {"mu+": "mu+/phi_data_2.txt"},
}
...
plot_combined_histogram(parsed_hwU_data, phi_values_e_plus, "/home/felipetcach/project/MG5_aMC_v3_5_6/pp_4l_wz_LOonly")
